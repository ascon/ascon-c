...
cmake .. -UALG_LIST -DEMULATOR="qemu-system-arm;-semihosting;-nographic;-machine;microbit;-kernel" \
         -DCMAKE_BUILD_TYPE=$TYPE \
         ...
         -DIMPL_LIST="armv6m;armv6m_lowsize"
cmake --build . --clean-first -- -k | tee -a ../test-all.log | grep "Built target genkat" >&3
ctest | sed -u 's/[0-9.]* sec//g' | tee -a ../test-all.log | grep Test >&3
...
cmake .. -DEMULATOR="qemu-system-riscv32;-semihosting;-nographic;-cpu;rv32;-bios;none;-kernel" \
         ...
         -DCMAKE_BUILD_TYPE=$TYPE -UALG_LIST \
         -DIMPL_LIST="asm_rv32i"
cmake --build . --clean-first -- -k | tee -a ../test-all.log | grep "Built target genkat" >&3
ctest | sed -u 's/[0-9.]* sec//g' | tee -a ../test-all.log | grep Test >&3
