...
for OPT in Os O1 O2 O3; do
  echo
  echo "Test clang -$OPT builds:" | tee -a ../test-crypto.log | grep Test >&3
  ...
  cmake --build . --clean-first -- -k | tee -a ../test-crypto.log | grep "Built target genkat" >&3
  ctest | tee -a ../test-crypto.log | grep Test >&3

  echo
  echo "Test gcc -$OPT builds:" | tee -a ../test-crypto.log | grep Test >&3
  ...
  echo
  echo "Test avx512 -$OPT builds:" | tee -a ../test-crypto.log | grep Test >&3
  cmake .. -DCMAKE_C_COMPILER=gcc -DALG_LIST="" -DIMPL_LIST=""
  ...
  echo
  echo "Test neon -$OPT builds:" | tee -a ../test-crypto.log | grep Test >&3
  ...
  echo "Test armv6m -$OPT builds:" | tee -a ../test-crypto.log | grep Test >&3
  cmake .. -DCMAKE_C_COMPILER=arm-linux-gnueabi-gcc -DALG_LIST="" -DIMPL_LIST=""
  cmake .. -UALG_LIST -DEMULATOR="qemu-arm;-L;/usr/arm-linux-gnueabi" \
  ...
  echo
  echo "Test armv7m -$OPT builds:" | tee -a ../test-crypto.log | grep Test >&3
  cmake .. -DCMAKE_C_COMPILER=arm-linux-gnueabi-gcc -DALG_LIST="" -DIMPL_LIST=""
  cmake .. -UALG_LIST -DEMULATOR="qemu-arm;-L;/usr/arm-linux-gnueabi" \
...
exit $(grep -c Failed test-crypto.log)
