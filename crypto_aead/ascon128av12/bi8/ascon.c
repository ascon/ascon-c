...
int crypto_aead_encrypt(unsigned char *c, unsigned long long *clen,
  ...
  if (adlen) {
    ...
    while (rlen >= RATE) {
      ...
      x0_6 ^= in_6;
      x0_7 ^= in_7;
      COMPRESS_BYTE_ARRAY_8((ad + 8), in_7, in_6, in_5, in_4, in_3, in_2, in_1,
                            in_0);
      x1_0 ^= in_0;
      x1_1 ^= in_1;
      x1_2 ^= in_2;
    ...
    buffer[rlen] = 0x80;
    for (i = rlen + 1; i < RATE; ++i) buffer[i] = 0;
    ...
    x0_6 ^= in_6;
    x0_7 ^= in_7;
    COMPRESS_BYTE_ARRAY_8((buffer + 8), in_7, in_6, in_5, in_4, in_3, in_2,
                          in_1, in_0);
    x1_0 ^= in_0;
    x1_1 ^= in_1;
    x1_2 ^= in_2;
  ...
  while (rlen >= RATE) {
    ...
    COMPRESS_BYTE_ARRAY_8((m + 8), in_7, in_6, in_5, in_4, in_3, in_2, in_1,
                          in_0);
    x1_0 ^= in_0;
    x1_1 ^= in_1;
    x1_2 ^= in_2;
    ...
    x1_6 ^= in_6;
    x1_7 ^= in_7;
    EXPAND_BYTE_ARRAY_8((c + 8), x1_7, x1_6, x1_5, x1_4, x1_3, x1_2, x1_1,
                        x1_0);
    P8_8;
    rlen -= RATE;
    m += RATE;
  ...
  COMPRESS_BYTE_ARRAY_8((buffer + 8), in_7, in_6, in_5, in_4, in_3, in_2, in_1,
                        in_0);
  x1_0 ^= in_0;
  x1_1 ^= in_1;
  x1_2 ^= in_2;
  ...
  x1_6 ^= in_6;
  x1_7 ^= in_7;
  EXPAND_BYTE_ARRAY_8((buffer + 8), x1_7, x1_6, x1_5, x1_4, x1_3, x1_2, x1_1,
                      x1_0);
...
int crypto_aead_decrypt(unsigned char *m, unsigned long long *mlen,
  ...
  *mlen = 0;
  ...
  while (rlen >= RATE) {
    ...
    EXPAND_BYTE_ARRAY_8((m + 8), x1_7, x1_6, x1_5, x1_4, x1_3, x1_2, x1_1,
                        x1_0);
    for (i = 0; i < RATE; ++i) m[i] ^= c[i];
    COMPRESS_BYTE_ARRAY_8(c, x0_7, x0_6, x0_5, x0_4, x0_3, x0_2, x0_1, x0_0);
    COMPRESS_BYTE_ARRAY_8((c + 8), x1_7, x1_6, x1_5, x1_4, x1_3, x1_2, x1_1,
                          x1_0);
    P8_8;
    rlen -= RATE;
    m += RATE;
  ...
  COMPRESS_BYTE_ARRAY_8(buffer, x0_7, x0_6, x0_5, x0_4, x0_3, x0_2, x0_1, x0_0);
  COMPRESS_BYTE_ARRAY_8((buffer + 8), x1_7, x1_6, x1_5, x1_4, x1_3, x1_2, x1_1,
                        x1_0);
